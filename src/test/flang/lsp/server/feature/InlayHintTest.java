...
public class InlayHintTest extends ExtendedBaseTest
{
  ...
  public void InlayHintsComposedArg()
  {
    ...
    assertEquals(18, maxEscapeIter.getPosition().getCharacter());
  }
  ...
  public void InlayHintsBoxedValue()
  {
    SourceText.setText(uri1, """
      ex =>
        ...
        String.type.from_codepoints (tmp.as_codepoints.as_stream.take 1).as_array
                    """);
    ...
    assertEquals(30, inlayHints.get(1).getPosition().getCharacter());
  }
